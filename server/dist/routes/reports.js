...
router.get('/dashboard', requirePermission('reports.view'), async (_req, res, next) => {
    try {
        ...
        const [totalProperties, totalContracts, activeContracts, totalLeads, totalDeals, monthlyRevenue, yearlyRevenue, pendingPayments, overduePayments, openTickets,] = await Promise.all([
