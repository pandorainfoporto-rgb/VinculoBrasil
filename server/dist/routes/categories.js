...
import { createCategory, listCategories, getCategory, updateCategory, deleteCategory, getCategoryTree, getAnalyticalCategories, } from '../controllers/category.controller.js';
const router = Router();
