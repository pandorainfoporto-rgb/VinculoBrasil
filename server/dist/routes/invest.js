 ...
 * Verifica apenas o status de um pedido (para polling)
 * Rota pública/leve para não sobrecarregar com autenticação
 *
 * Returns: { status, txHash?, settledAt? }
 */
router.get('/orders/:orderId/status', investController.getOrderStatus);
/**
