...
import { mintContract, getBlockchainStatus, getContractNFT, estimateMintCost, } from '../controllers/contract.controller.js';
import { simulateContractTermination, executeContractTermination, } from '../controllers/termination.controller.js';
const router = Router();
// ============================================
...
router.post('/:id/simulate-termination', requirePermission('contracts.update'), simulateContractTermination);
// Executar rescisão (ação definitiva)
router.post('/:id/terminate', requirePermission('contracts.update'), executeContractTermination);
