 ...
 */
export async function createRealtor(req, res, next) {
    try {
        const { name, creci, email, phone, cpf, agencyId, customCommissionSplit, pixKey, pixKeyType, } = req.body;
        // Validation
 ...
 */
export async function listRealtors(req, res, next) {
    try {
 ...
 */
export async function getRealtorById(req, res, next) {
    try {
        const { id } = req.params;
 ...
 */
export async function updateRealtor(req, res, next) {
    try {
        const { id } = req.params;
 ...
 */
export async function deleteRealtor(req, res, next) {
    try {
        const { id } = req.params;
        // Check if realtor exists
        const existing = await prisma.realtor.findUnique({
