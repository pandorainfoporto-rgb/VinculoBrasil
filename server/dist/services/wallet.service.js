 ...
 */
export const createManagedWallet = async (userId) => {
    try {
 ...
 */
export const getUserWallet = async (userId, provider) => {
 ...
 */
export const hasWallet = async (userId) => {
    const user = await prisma.user.findUnique({
        where: { id: userId },
 ...
 */
export const migrateUsersWithoutWallets = async () => {
