 ...
 */
export const settleInvestmentOrder = async (asaasPaymentId) => {
    ...
    try {
        ...
        const receivablesContractAddress = process.env.VITE_RECEIVABLES_CONTRACT_ADDRESS ||
            process.env.RECEIVABLES_CONTRACT_ADDRESS ||
            '0x4081D8c80bae80aB36AaE3e83082BE1083C32F9A';
        const receivablesContract = new ethers.Contract(receivablesContractAddress, RECEIVABLES_ABI, adminWallet);
        ...
        const tx = await receivablesContract.safeTransferFrom(listing.sellerWallet, // De quem sai
