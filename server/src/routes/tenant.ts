...
// ============================================
router.get('/dashboard', requireTenant, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const userId = (req as any).user?.id;
...
// ============================================
router.get('/contract', requireTenant, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const userId = (req as any).user?.id;
...
// ============================================
router.get('/payments', requireTenant, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const userId = (req as any).user?.id;
...
// Perfil do inquilino
// ============================================
router.get('/profile', requireTenant, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const userId = (req as any).user?.id;
...
// ============================================
router.patch('/profile', requireTenant, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const userId = (req as any).user?.id;
