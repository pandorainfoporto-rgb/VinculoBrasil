 ...
 */
export const mintContract = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const getBlockchainStatus = async (_req: Request, res: Response) => {
 ...
 */
export const getContractNFT = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
 ...
 */
export const estimateMintCost = async (_req: Request, res: Response, next: NextFunction) => {
  try {
    const wallet = getAdminWallet();
    const contract = await getContract(wallet);
