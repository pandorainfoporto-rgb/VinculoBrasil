...
// @ts-nocheck
import { PrismaClient, Prisma, Investor } from '@prisma/client';
import bcrypt from 'bcryptjs';

const prisma = new PrismaClient();

// Types derived from Prisma for type safety
...
export const investorService = {
     ...
     */
    create: async (data: CreateInvestorInput) => {
     ...
     */
    update: async (id: string, data: UpdateInvestorInput) => {
        return prisma.$transaction(async (tx) => {
            ...
            if (!investorHelper) throw new Error("Investor not found");
